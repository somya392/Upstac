...
public class LabRequestController {
    ...
    public List<TestRequest> getForTester()  {
        ...
        /* Now we will use findByTester() method of TestRequestQueryService
        The method will be accessed via existing object testRequestQueryService
        findByTester is an already implemented method which takes object of User class as parameter
        and returns list of all test requests assigned to current tester */
